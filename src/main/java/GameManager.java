...
public class GameManager {
    public void fight(Character c1, Character c2) {
        ...
        int temp_hp = 0;
        int rand_int;
        ArrayList<Character> characters = new ArrayList<Character>(Arrays.asList(c1, c2));
        ...
        while (c1.isAlive() && c2.isAlive()) {
            ...
            c1.kick(c2);
            temp_hp -= c2.getHp();
            System.out.println(c1.getClass().getName() + (2 - rand_int) + " kicked " + c2.getClass().getName() + (1 + rand_int) + " for " + temp_hp);
